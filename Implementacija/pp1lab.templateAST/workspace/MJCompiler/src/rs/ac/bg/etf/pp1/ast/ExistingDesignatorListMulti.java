...
public class ExistingDesignatorListMulti extends DesignatorList {

    private DesignatorList DesignatorList;
    private DesignatorElement DesignatorElement;

    public ExistingDesignatorListMulti (DesignatorList DesignatorList, DesignatorElement DesignatorElement) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ExistingDesignatorListMulti(\n");
