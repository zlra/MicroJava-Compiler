...
public interface Visitor { 
    ...
    public void visit(SingleCondFactList SingleCondFactList);
    public void visit(MultiCondFactList MultiCondFactList);
    public void visit(CondTerm CondTerm);
    public void visit(Or Or);
    public void visit(SingleCondTermList SingleCondTermList);
    public void visit(MultiCondTermList MultiCondTermList);
    public void visit(Condition Condition);
    public void visit(ElseDerived1 ElseDerived1);
    ...
    public void visit(IfThenPart IfThenPart);
