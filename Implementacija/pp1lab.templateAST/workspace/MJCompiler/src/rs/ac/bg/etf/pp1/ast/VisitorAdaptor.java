...
public abstract class VisitorAdaptor implements Visitor { 
    ...
    public void visit(SingleCondFactList SingleCondFactList) { visit(); }
    public void visit(MultiCondFactList MultiCondFactList) { visit(); }
    public void visit(CondTerm CondTerm) { visit(); }
    public void visit(Or Or) { visit(); }
    public void visit(SingleCondTermList SingleCondTermList) { visit(); }
    public void visit(MultiCondTermList MultiCondTermList) { visit(); }
    public void visit(Condition Condition) { visit(); }
    public void visit(ElseDerived1 ElseDerived1) { visit(); }
    ...
    public void visit(IfThenPart IfThenPart) { visit(); }
    ...
    public void visit(WhileCond WhileCond) { visit(); }
