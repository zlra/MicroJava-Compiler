...
public class ExistingMethodDeclarationList extends MethodDeclarationList {

    private MethodDeclarationList MethodDeclarationList;
    private MethodDeclaration MethodDeclaration;

    public ExistingMethodDeclarationList (MethodDeclarationList MethodDeclarationList, MethodDeclaration MethodDeclaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ExistingMethodDeclarationList(\n");
