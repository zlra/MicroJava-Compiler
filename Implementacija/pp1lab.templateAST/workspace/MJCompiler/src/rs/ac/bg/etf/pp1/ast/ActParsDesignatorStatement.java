...
public class ActParsDesignatorStatement extends DesignatorStatement {

    private Designator Designator;
    private OptionalActPars OptionalActPars;

    public ActParsDesignatorStatement (Designator Designator, OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ActParsDesignatorStatement(\n");
