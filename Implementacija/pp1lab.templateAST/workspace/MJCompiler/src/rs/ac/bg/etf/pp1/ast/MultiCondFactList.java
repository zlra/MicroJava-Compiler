...
public class MultiCondFactList extends CondFactList {

    private CondFact CondFact;
    private CondFactList CondFactList;

    public MultiCondFactList (CondFact CondFact, CondFactList CondFactList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MultiCondFactList(\n");
