...
public class DeclarationListClassElement extends DeclarationListElement {

    private ClassDecl ClassDecl;

    public DeclarationListClassElement (ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DeclarationListClassElement(\n");
